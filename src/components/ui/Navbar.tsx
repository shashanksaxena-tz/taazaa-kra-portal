    ...
    <header className="sticky top-0 z-40 w-full backdrop-blur-xl bg-white/95 dark:bg-[#07091E]/95 border-b border-slate-200/80 dark:border-slate-800/80 transition-colors">
      <div className="w-full max-w-[1720px] mx-auto px-6 sm:px-10 lg:px-14">
        <div className="flex items-center justify-between h-16 sm:h-20">
          ...
          >
            <div className="relative flex items-center justify-center w-10 h-10 rounded-xl bg-[#FF5B22] shadow-md shadow-[#FF5B22]/25 text-white font-black text-xl tracking-tight">
              <span>T</span>
          ...
          <div className="flex items-center gap-2 sm:gap-3">
            ...
            >
              ...
              {comparisonRoles.length > 0 && (
                <span className="flex items-center justify-center w-5 h-5 text-xs font-black text-white bg-[#FF5B22] rounded-full">
