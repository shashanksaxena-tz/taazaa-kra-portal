...
export const TaazaaBackgroundLayer: React.FC = () => {
  return (
    <div className="fixed inset-0 pointer-events-none overflow-hidden z-0 select-none print:hidden">
      ...
      {/* 1. High-Contrast Full-Screen Interconnected Hexagon Tessellation (Shared-Side Honeycomb Grid) */}
      <svg 
        className="absolute inset-0 w-full h-full opacity-[0.22] dark:opacity-[0.32] text-teal-700 dark:text-[#29E8AE]" 
      ...
      >
        <defs>
          ...
          >
            ...
            <circle cx="60" cy="20" r="3" fill="#059669" className="dark:fill-[#29E8AE]" />
            <circle cx="87.7" cy="36" r="2.5" fill="#0D9488" className="dark:fill-[#29E8AE]" fillOpacity="0.9" />
            <circle cx="87.7" cy="68" r="3" fill="#059669" className="dark:fill-[#29E8AE]" />
            <circle cx="60" cy="84" r="2.5" fill="#0D9488" className="dark:fill-[#29E8AE]" fillOpacity="0.9" />
            <circle cx="32.3" cy="68" r="3" fill="#059669" className="dark:fill-[#29E8AE]" />
            <circle cx="32.3" cy="36" r="2.5" fill="#0D9488" className="dark:fill-[#29E8AE]" fillOpacity="0.9" />
          </pattern>
        </defs>
        <rect width="100%" height="100%" fill="url(#taazaa_hex_pattern)" />
      </svg>

      {/* 2. Floating Multi-Sized Hexagon Clusters with High Contrast & Shaded Facets */}
      
      {/* Cluster 1: Top-Right Giant Hexagon System */}
      <div className="absolute -top-12 right-[-2%] sm:right-6 lg:right-16 w-[380px] sm:w-[560px] opacity-[0.45] dark:opacity-[0.48] transition-opacity">
      ...
      <div className="absolute top-[34%] -left-10 sm:left-4 w-[300px] sm:w-[440px] opacity-[0.40] dark:opacity-[0.44] transition-opacity">
      ...
      <div className="absolute bottom-6 right-4 sm:right-16 w-[320px] sm:w-[480px] opacity-[0.38] dark:opacity-[0.42] transition-opacity">
      ...
      <div 
        className="absolute -top-32 right-[-5%] w-[750px] h-[750px] rounded-full blur-[140px] opacity-[0.25] dark:opacity-[0.28]"
        style={{ background: 'radial-gradient(circle, #29E8AE 0%, rgba(6, 182, 212, 0.4) 50%, transparent 70%)' }}
      />
      <div 
        className="absolute bottom-10 left-[-10%] w-[650px] h-[650px] rounded-full blur-[140px] opacity-[0.18] dark:opacity-[0.22]"
