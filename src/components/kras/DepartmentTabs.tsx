    ...
    <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-6">
      <div className="flex items-center gap-2 overflow-x-auto pb-2 scrollbar-none">
        ...
        <button
          ...
          className={`relative flex items-center gap-2.5 px-4 py-3 rounded-2xl text-sm font-bold whitespace-nowrap transition-all border ${
            activeDepartmentId === 'all'
              ? 'bg-slate-900 text-white dark:bg-orange-600 dark:text-white border-transparent shadow-md'
